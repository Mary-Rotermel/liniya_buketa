...
export const products: Product[] = [
  ...
  },
  {
    ...
    alt: "Букет Малиновое облако с пионовидными розами, белой эустомой и фрезией",
  ...
  {
    slug: "persikovoe-solntse",
    name: "Персиковое солнце",
    category: "Авторские букеты",
    composition: "Кустовая хризантема, роза, гербера, солидага, эвкалипт, упаковка",
    price: "6 800 ₽",
    image: "/images/bouquets/persikovoe-solntse.jpg",
    alt: "Авторский букет Персиковое солнце с кустовой хризантемой, розой, герберой, солидагой и эвкалиптом",
    details: "Тёплый авторский букет с персиковыми герберами, жёлтыми и зелёными акцентами. Подойдёт для яркого поздравления и солнечного комплимента."
  },
  {
    slug: "nebesnyj-briz",
    name: "Небесный бриз",
    category: "Авторские букеты",
    composition: "Хризантемы, розы, гвоздики, эрингиум, хлопок, солидага, зелёные акценты, упаковка",
    price: "5 500 ₽",
    image: "/images/bouquets/nebesnyj-briz.png",
    alt: "Голубой авторский букет Небесный бриз с хризантемами, жёлтыми розами, хлопком и зеленью",
    details: "Свежий авторский букет в голубой гамме с жёлтыми акцентами. Подойдёт для яркого поздравления и необычного комплимента."
  },
  {
    slug: "zhemchuzhnyj-sad",
    name: "Жемчужный сад",
    category: "Авторские букеты",
    composition: "Розы, орхидея цимбидиум, хризантемы, гортензия, зелень, упаковка",
    price: "6 900 ₽",
    image: "/images/bouquets/zhemchuzhnyj-sad.png",
    alt: "Светлый авторский букет Жемчужный сад с розами, орхидеей, хризантемами и гортензией",
    details: "Светлый букет в персиково-кремовой гамме с орхидеями и мягкой упаковкой. Хорошо подходит для нежного праздничного подарка."
  },
  {
